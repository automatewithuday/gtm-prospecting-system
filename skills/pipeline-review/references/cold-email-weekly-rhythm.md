...
- If any campaign failed the 1% rule: run [`/deliverability-incident-response`](https://github.com/automatewithuday/GTM-Skills/tree/main/skills/deliverability-incident-response) → triage decision tree
...
3. Decide:
   ...
   - **Middling (near baseline):** iterate on copy or list — run [`/experiment-design`](https://github.com/automatewithuday/GTM-Skills/tree/main/skills/experiment-design) Monday to plan the next variant
...
**Critical:** do not skip the log. Over a quarter, these logs become the input for [`/experiment-design`](https://github.com/automatewithuday/GTM-Skills/tree/main/skills/experiment-design) quarterly reviews. Without the history, you can't learn across campaigns.
...
**If insurance pool is getting thin (<5 inboxes available to rotate in):** kick off a new domain purchase cycle via [`/zapmail-domain-setup-public`](https://github.com/automatewithuday/GTM-Skills/tree/main/skills/zapmail-domain-setup-public). It takes ~2 weeks from purchase to sendable, so you need to start early.

---

## Monthly (1st of the month) — Spam placement test (25 min active, test runs ~20 min)

**Run:** the Smart Delivery spam placement test from [`/email-deliverability-audit`](https://github.com/automatewithuday/GTM-Skills/tree/main/skills/email-deliverability-audit):
...
- **<80%:** red. Pause the campaign, run [`/deliverability-incident-response`](https://github.com/automatewithuday/GTM-Skills/tree/main/skills/deliverability-incident-response), fix before sending more.
...
Use the retrospective as input to design next quarter's experiments via [`/experiment-design`](https://github.com/automatewithuday/GTM-Skills/tree/main/skills/experiment-design).
...
- [`/email-deliverability-audit`](https://github.com/automatewithuday/GTM-Skills/tree/main/skills/email-deliverability-audit) — the Monday and Monthly tasks
- [`/reply-classification`](../reply-classification/SKILL.md) — the Wednesday and Friday tasks
- [`/smartlead-inbox-manager`](https://github.com/automatewithuday/GTM-Skills/tree/main/skills/smartlead-inbox-manager) — the biweekly inbox rotation
- [`/deliverability-incident-response`](https://github.com/automatewithuday/GTM-Skills/tree/main/skills/deliverability-incident-response) — when the Monday audit flags something
- [`/experiment-design`](https://github.com/automatewithuday/GTM-Skills/tree/main/skills/experiment-design) — the quarterly retrospective feeds into this
- [`/zapmail-domain-setup-public`](https://github.com/automatewithuday/GTM-Skills/tree/main/skills/zapmail-domain-setup-public) — when insurance pool runs low
