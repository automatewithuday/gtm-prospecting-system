...
**If flags cleared:** run [`/smartlead-spintax`](https://github.com/automatewithuday/GTM-Skills/tree/main/skills/smartlead-spintax) before upload, then launch via [`/smartlead-campaign-upload-public`](https://github.com/automatewithuday/GTM-Skills/tree/main/skills/smartlead-campaign-upload-public).

**If flags fired:** back to [`/cold-email`](../cold-email/SKILL.md) to rewrite the flagged lines. Re-run this check after.
...
- [`/cold-email`](../cold-email/SKILL.md) — produces the copy this skill screens
