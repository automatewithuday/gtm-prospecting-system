---
name: cold-email
description: "Use when stage 14 of the prospecting system needs the first-touch cold email written per segment from approved personalization variables. Also use standalone when writing or fixing cold email that has to land in the primary inbox and get replies."
license: MIT
metadata:
  author: automatewithuday
  source: martechs.io
  ported_from: GTM-Skills/skills/b2b-cold-email-copywriting/SKILL.md
---
...
**Stage 14 of 20.** Reads `13-personalized.csv`, `02-client-profile.yaml`. Writes `14-emails.csv` (`lead_id, segment, framework, subject, body, variant`).

- One framework per segment, 2 variants max. Write the template once per segment with merge variables; do not hand-write 500 emails.
- Run the pre-send QA checklist (section 13) and the spam-word pass (`references/spam-word-checker.md`) on every template.
- This stage DRAFTS. Nothing is uploaded or sent by the prospecting system; the human takes `14-emails.csv` to their sender.
- More frameworks: `references/copy-frameworks.md`.
...
- [spam-word-checker](https://github.com/automatewithuday/GTM-Skills/tree/main/skills/spam-word-checker) to scan a finished draft against section 9.
- [smartlead-spintax](https://github.com/automatewithuday/GTM-Skills/tree/main/skills/smartlead-spintax) to apply section 8 at upload time.
- [campaign-copywriting](../cold-email/SKILL.md) for the stepwise direction, subject, body, YAML flow.
- [email-deliverability-audit](https://github.com/automatewithuday/GTM-Skills/tree/main/skills/email-deliverability-audit) when section 1 is the real problem.
