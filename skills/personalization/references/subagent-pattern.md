...
- When [`/auto-research-public`](https://github.com/automatewithuday/GTM-Skills/tree/main/skills/auto-research-public) or similar orchestration skills need parallel personalization
...
- `references/example-output.json` — what a well-personalized batch looks like *(not shipped yet)*
- `references/failure-modes.md` — common sub-agent failures and how to detect them *(not shipped yet)*

## What to do next

**This is a pattern doc, not a standalone skill.** It's invoked by [`/auto-research-public`](https://github.com/automatewithuday/GTM-Skills/tree/main/skills/auto-research-public) and [`/cold-email`](../cold-email/SKILL.md) when they need per-lead personalization at scale.
...
- [`/auto-research-public`](https://github.com/automatewithuday/GTM-Skills/tree/main/skills/auto-research-public) — the primary consumer of this pattern
- [`/icp-definition`](../icp-definition/SKILL.md) — produces the `client-profile.yaml` the prompt pulls from
- [`/cold-email-starter-kit`](https://github.com/automatewithuday/GTM-Skills/tree/main/skills/cold-email-starter-kit) references `03-campaign-copywriting.md` for copy principles the prompt enforces
