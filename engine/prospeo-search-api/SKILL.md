...
This is a reference skill — no direct next step. Used by [`/prospeo-full-export`](../prospeo-full-export/SKILL.md) and [`/auto-research-public`](../auto-research-public/SKILL.md) to build the actual search.

Return to the skill that sent you here.

## Related skills

- [`/prospeo-full-export`](../prospeo-full-export/SKILL.md) — the main consumer of this reference
- [`/auto-research-public`](../auto-research-public/SKILL.md) — also uses Prospeo search via phase-prospeo.ts
